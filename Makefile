...
telegram/set-webhook/local:
	curl "https://api.telegram.org/bot7944292479:AAEnzoQ_YGmj5qLWFxfabMweto_NDmg-u0c/setWebhook?url=https://d9c3-42-70-132-7.ngrok-free.app/v1/webhooks/telegram" -X POST